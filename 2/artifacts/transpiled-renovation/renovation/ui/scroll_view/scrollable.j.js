...
var Scrollable = /*#__PURE__*/function (_ScrollableWrapper) {
  ...
  _proto.scrollBy = function scrollBy(distance) {
    ...
    return (_this$viewRef3 = this.viewRef) === null || _this$viewRef3 === void 0 ? void 0 : _this$viewRef3.scrollBy.apply(_this$viewRef3, arguments);
  };

  _proto.update = function update() {
    var _this$viewRef4;

    return (_this$viewRef4 = this.viewRef) === null || _this$viewRef4 === void 0 ? void 0 : _this$viewRef4.update.apply(_this$viewRef4, arguments);
  };

  _proto.release = function release() {
    var _this$viewRef5;

    return (_this$viewRef5 = this.viewRef) === null || _this$viewRef5 === void 0 ? void 0 : _this$viewRef5.release.apply(_this$viewRef5, arguments);
  };

  _proto.refresh = function refresh() {
    var _this$viewRef6;

    return (_this$viewRef6 = this.viewRef) === null || _this$viewRef6 === void 0 ? void 0 : _this$viewRef6.refresh.apply(_this$viewRef6, arguments);
  };

  _proto.scrollTo = function scrollTo(targetLocation) {
    var _this$viewRef7;

    return (_this$viewRef7 = this.viewRef) === null || _this$viewRef7 === void 0 ? void 0 : _this$viewRef7.scrollTo.apply(_this$viewRef7, arguments);
  };
  ...
  _proto.scrollToElementTopLeft = function scrollToElementTopLeft(element) {
    ...
    var params = [this._patchElementParam(element)];
    return (_this$viewRef17 = this.viewRef) === null || _this$viewRef17 === void 0 ? void 0 : _this$viewRef17.scrollToElementTopLeft.apply(_this$viewRef17, _toConsumableArray(params.slice(0, arguments.length)));
  };

  _proto.startLoading = function startLoading() {
    var _this$viewRef18;

    return (_this$viewRef18 = this.viewRef) === null || _this$viewRef18 === void 0 ? void 0 : _this$viewRef18.startLoading.apply(_this$viewRef18, arguments);
  };

  _proto.finishLoading = function finishLoading() {
    var _this$viewRef19;

    return (_this$viewRef19 = this.viewRef) === null || _this$viewRef19 === void 0 ? void 0 : _this$viewRef19.finishLoading.apply(_this$viewRef19, arguments);
  };
