...
function __createDefaultProps() {
  return _extends({}, ResizableHandleProps, convertRulesToOptions([]));
}
...
export function defaultOptions(rule) {
  ...
  ResizableHandle.defaultProps = _extends({}, __createDefaultProps(), convertRulesToOptions(__defaultOptionRules));
}